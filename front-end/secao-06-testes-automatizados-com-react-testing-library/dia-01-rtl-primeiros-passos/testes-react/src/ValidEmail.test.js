...
// Utiliza-se o 'queryBy' em vez do 'getBy', pois o getBy retorna um erro caso o elemento não seja encontrado, encerrando o teste; já o queryBy retorna null, sendo útil para verificar a não existência de algum elemento na página.
...
// A função 'toHaveAttribute' verifica se o elemento possui a classe com o nome esperado para cada situação.
